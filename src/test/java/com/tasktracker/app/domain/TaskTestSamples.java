...
public class TaskTestSamples {
    ...
    public static Task getTaskSample1() {
        return new Task().id(1L).taskId(1L).title("title1").description("description1");
    }

    public static Task getTaskSample2() {
        return new Task().id(2L).taskId(2L).title("title2").description("description2");
    }

    public static Task getTaskRandomSampleGenerator() {
        return new Task()
            .id(longCount.incrementAndGet())
            .taskId(longCount.incrementAndGet())

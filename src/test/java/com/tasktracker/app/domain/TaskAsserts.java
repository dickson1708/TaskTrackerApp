...
import static com.tasktracker.app.domain.AssertUtils.zonedDataTimeSameInstant;
...
public class TaskAsserts {
    ...
    public static void assertTaskUpdatableFieldsEquals(Task expected, Task actual) {
        assertThat(actual)
            ...
            .satisfies(a -> assertThat(a.getTaskId()).as("check taskId").isEqualTo(expected.getTaskId()))
